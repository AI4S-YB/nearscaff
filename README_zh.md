...
| 总大小 | 564.0 Mb | 挂载 430.9 Mb（76.4%） |
| N50 | 0.019 Mb | 33.7 Mb（scaffold） |
...
| 总大小 | 456.0 Mb | 挂载 440.0 Mb（96.5%） |
| N50 | 2.95 Mb | 33.3 Mb（scaffold） |
...
使用 embryophyta_odb10（n=1614，euk_genome_min 模式），分两种口径：
"染色体骨架"仅统计 14 条 scaffold；"完整输出"统计工具输出的全部序列
（两个工具的输出文件默认都包含未挂载的 contig）。
...
| BUSCO — 染色体骨架 | C:86.6% [S:85.2%, D:1.4%], F:4.8%, M:8.6% | **C:88.3%** [S:86.1%, D:2.2%], F:8.9%, M:2.9% |
| BUSCO — 完整输出 | C:93.0% [S:90.8%, D:2.2%], F:5.5%, M:1.5% | C:89.7% [S:87.3%, D:2.4%], F:8.6%, M:1.7% |
...
| BUSCO — 染色体骨架 | C:97.2% [S:95.2%, D:2.0%], F:1.8%, M:1.0% | **C:97.5%** [S:95.5%, D:2.0%], F:1.9%, M:0.6% |
| BUSCO — 完整输出 | C:97.8% [S:95.5%, D:2.4%], F:2.0%, M:0.2% | C:97.8% [S:95.5%, D:2.3%], F:2.0%, M:0.2% |

注：案例 1 中 RagTag 完整输出的 BUSCO（93.0%）明显高于其染色体骨架
本身（86.6%），该异常仍在排查，建议以染色体骨架口径为准。
